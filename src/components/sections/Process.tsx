...
const steps = [
  {
    ...
    description: "Configurás tu paquete ideal en nuestra plataforma en minutos.",
    icon: Search,
  ...
  },
  {
    ...
    description: "Nos juntamos para alinear visión, objetivos y requerimientos específicos.",
    icon: Users,
    color: "text-brand-emerald",
    bg: "bg-brand-emerald/10",
  },
  {
    title: "Prototipo + Contenido",
    description: "Creamos la estructura visual y definimos los copies de alto impacto.",
    icon: Layout,
  ...
  },
  {
    ...
    description: "Pulimos detalles finales contigo para asegurar la perfección.",
    icon: MessageSquare,
  ...
  {
    title: "Live",
    description: "Lanzamos tu sitio optimizado y listo para escalar tu negocio.",
    icon: Rocket,
    color: "text-red-400",
    bg: "bg-red-400/10",
  },
